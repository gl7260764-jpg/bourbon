    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[100] flex items-center justify-center bg-bourbon-deep/95 backdrop-blur-md"
        >
          <motion.div
            ...
            className="relative max-w-md w-full mx-4 p-10 bg-bourbon-dark border border-bourbon-gold/30 text-center"
          >
            {/* Decorative corners */}
