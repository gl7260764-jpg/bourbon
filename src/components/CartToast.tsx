        ...
        <AnimatePresence>
          {toasts.map((toast) => (
            <motion.div
              ...
              className="pointer-events-auto flex items-center gap-3 bg-bourbon-deep border border-bourbon-gold/30 p-3 pr-4 sm:pr-5 shadow-xl shadow-black/20 w-full sm:w-auto sm:min-w-[280px] sm:max-w-sm"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-bourbon-cream text-sm font-medium truncate">
                  {toast.name}
                </p>
